...
void Game::CreateGame2() // игра между компьютером и человеком
{
...
void Game::HandleInput()
{
	...
	else if(temp==StateMenu::PLAY_GAME)
	{
		...
		{
			//CreateGame1(); функция тоже закомментирована
		}
		if(modeGame==ModeGame::PvsCPU)  // выбор игры между компьютером и человеком 
		{
			CreateGame2();
		}
